...
set matchtime=2
set ruler
set runtimepath=~/.vim_runtime/my_plugins/vim-rails,~/.vim_runtime/sources_non_forked/ack.vim,~/.vim_runtime/sources_non_forked/ale,~/.vim_runtime/sources_non_forked/auto-pairs,~/.vim_runtime/sources_non_forked/bufexplorer,~/.vim_runtime/sources_non_forked/comfortable-motion.vim,~/.vim_runtime/sources_non_forked/ctrlp.vim,~/.vim_runtime/sources_non_forked/goyo.vim,~/.vim_runtime/sources_non_forked/gruvbox,~/.vim_runtime/sources_non_forked/jellybeans.vim,~/.vim_runtime/sources_non_forked/lightline-ale,~/.vim_runtime/sources_non_forked/lightline.vim,~/.vim_runtime/sources_non_forked/mayansmoke,~/.vim_runtime/sources_non_forked/mru.vim,~/.vim_runtime/sources_non_forked/nerdtree,~/.vim_runtime/sources_non_forked/nginx.vim,~/.vim_runtime/sources_non_forked/open_file_under_cursor.vim,~/.vim_runtime/sources_non_forked/rust.vim,~/.vim_runtime/sources_non_forked/snipmate-snippets,~/.vim_runtime/sources_non_forked/tabular,~/.vim_runtime/sources_non_forked/tlib,~/.vim_runtime/sources_non_forked/vim-abolish,~/.vim_runtime/sources_non_f
set scrolloff=7
set shiftwidth=2
set showmatch
set showtabline=2
...
silent only
silent tabonly
cd ~/Development/code/redux/using-redux-with-react/redux-delete-lab-v-000
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/components/Band.js
badd +4 ~/Development/code/redux/using-redux-with-react/redux-delete-codealong-v-000/src/components/todos/Todo.js
badd +0 src/components/Bands.js
badd +7 ~/Development/code/redux/using-redux-with-react/redux-delete-codealong-v-000/src/components/todos/Todos.js
badd +0 src/components/BandInput.js
badd +0 ~/Development/code/redux/using-redux-with-react/building-forms-lab-v-000/src/components/BandInput.js
badd +0 ~/Development/code/redux/using-redux-with-react/building-forms-lab-v-000/src/components/Bands.js
argglobal
silent! argdel *
$argadd .
tabnew
tabnext -1
edit src/components/Band.js
...
wincmd w
argglobal
if bufexists('src/components/Bands.js') | buffer src/components/Bands.js | else | edit src/components/Bands.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('src/components/BandInput.js') | buffer src/components/BandInput.js | else | edit src/components/BandInput.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
exe 'vert 4resize ' . ((&columns * 89 + 181) / 362)
tabnext
edit ~/Development/code/redux/using-redux-with-react/building-forms-lab-v-000/src/components/Bands.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 163 + 181) / 362)
exe 'vert 2resize ' . ((&columns * 162 + 181) / 362)
...
wincmd w
argglobal
if bufexists('~/Development/code/redux/using-redux-with-react/building-forms-lab-v-000/src/components/BandInput.js') | buffer ~/Development/code/redux/using-redux-with-react/building-forms-lab-v-000/src/components/BandInput.js | else | edit ~/Development/code/redux/using-redux-with-react/building-forms-lab-v-000/src/components/BandInput.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
